  ...
  <body>
    <section>
      <div class="jumbotron">
        <div class="container">
          <h1>Katalog</h1>
          <p>Proizvodi u nasem svijetu bijele tenike</p>
        </div>
      </div>
      
    </section>
	
	<a href="products/add" style="margin:30px">Login</a>
          ...
          <div class="col-sm-6 col-md-3" style="padding-bottom: 15px">
            ...
            <img src="<c:url value="/resource/images/${product.productId}.png">
              ...
              <div class="caption">
                ...
                <p>Dostupno:  ${product.unitsInStock} </p>
                <p> 
<a  href=" <spring:url value=  "/products/product?
id=${product.productId}" /> " class="btn btn-primary">
<span class="glyphicon-info-sign glyphicon"/></span> Informacije:
</a>
</p>
